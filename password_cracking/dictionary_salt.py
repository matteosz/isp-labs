...
digests = { '962642e330bd50792f647c1bf71895c5990be4ebf6b3ca60332befd732aed56c' , 
...
salt = ['b9','be','bc','72','9f','17','94','7f','2e','24']

def run(word):
    for s in salt:
        hash = hashlib.sha256((word+s).encode()).hexdigest()
        if hash in digests:
            print(hash + '->' + word)
